...
中国剰余定理(CRT)を使う場合は，$m_1m_2\cdots m_k-1$以下の整数を管理できるような多倍長変数などが必要になる
...
そのようなもののうち一つを，$m_1,m_2,m_3$のmodで求める  
ところで，$v$は$m_1\cdots m_k$通りなので，  
$v$は唯一つに定まる
...
ところで，$v_1 \lt m_1$なので$\mod m_1$を$m_1$で割ったあまり，とすると$v_1 = x_1$である  
($\equiv$ではなく$=$であることが重要，つまり厳密値がわかる)
...
$m_1$と$m_2$は互いに素なので，逆元掛けて（もしくはextgcdで)  
$v_2 \mod m_2$がもとまります
...
$x_i,v_i$以外の変数はすべて厳密値が分かっているので，$\mod m_i$での値を求めることができ，  
$m_1m_2\cdots m_{i-1}$と$m_i$は互いに素なので，逆元かけて，  
$v_i$の$\mod m_i$，もとより厳密値が求まります
