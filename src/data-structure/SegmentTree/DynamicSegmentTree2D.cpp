...
public:
  void set(int x, int y, T const &val) {
    setx(x, y, val, 0, sizex, top, 1);
  }
  void act(int x, int y, T const &val) {
    setx(x, y, val, 0, sizex, top, 0);
  }
private:
