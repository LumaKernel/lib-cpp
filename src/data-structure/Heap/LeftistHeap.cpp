...
LeftistHeap<T> * meld(LeftistHeap<T> * a, LeftistHeap<T> * b, const Compare & comp = Compare()) {
...
template<class T, class Compare = std::less<T> >
inline LeftistHeap<T> * push(LeftistHeap<T> *& a, T const & e, const Compare & comp = Compare()) {
